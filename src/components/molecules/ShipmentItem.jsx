    ...
    return (
        <>
            <BoxLayout state={state}>
                <div className={"flex flex-col gap-5 items-center w-full " + `${isExpired && "pointer-events-none opacity-50"}`}>
                    ...
                    <div className="w-full flex flex-col items-center justify-center gap-4">
                        ...
                        {state == 0 && <div className={"mt-2 w-full " + `${(isValid) ? "" : "pointer-events-none opacity-70"}`}><SubmitBtn loading={loading} context={isExpired ? "مهلت ثبت درخواست پایان یافت" : "ارسال پیشنهاد قیمت"} onClick={handleSubmit(submit)} color={"Red"} /></div>}
